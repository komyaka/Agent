...
Use this prompt to start any task — a new program, website, module, bug fix, refactor, or any other development work. Заполни in the sections marked with `[...]` and hand it to the **Orchestrator** agent.
